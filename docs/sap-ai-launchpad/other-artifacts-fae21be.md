...
-   An artifact can be manually added using SAP AI Launchpad \(see [Add an Other Artifact](add-an-other-artifact-c02fca9.md)\). You add an artifact using the *ML Operations* app. After you add an artifact, you'll see it listed with all other artifacts in the app.

-   An other artifact set can be manually added using SAP AI Core \(see [Create Artifacts](https://help.sap.com/docs/AI_CORE/808d9d442fb0484e9b818924feeb9add/CLOUD/66413f1d9fbf4758a0d739eaf1c95dc7.html)\).


-   **[Add an Other Artifact](add-an-other-artifact-c02fca9.md "Use the ML
                                    Operations app to manually add an “other”
		artifact that is stored in your object store.")**  
Use the *ML Operations* app to manually add an “other” artifact that is stored in your object store.
