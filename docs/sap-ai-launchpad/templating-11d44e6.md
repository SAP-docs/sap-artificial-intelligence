...
For selected models, image and PDF inputs are supported, and can be added using the <span class="SAP-icons-V5"></span> \(add document\)icon or copy and paste. Prompt messages are limited to 5.00mb across all inputs.
