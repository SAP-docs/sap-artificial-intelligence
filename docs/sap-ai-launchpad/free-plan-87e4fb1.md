<!-- loio87e4fb191e3746c0850f76642da96871 -->
...
You can use the free plan option and benefit from the following advantages:

-   Explore SAP AI Launchpad features and capabilities without cost.

-   Migrate from the free plan to a standard service plan whilst retaining your work.
...
-   The free plan option is subject to usage limits. See [Service Plans](service-plans-ec1717d.md).


> ### Note:  
> The generative AI hub is a feature of the standard plan only, and is **not** available through free plan. For more information, see [Service Plans](service-plans-ec1717d.md).
...
Enable the free plan option to use SAP AI Launchpad with usage limits, to familiarize yourself with the service.
...
> ### Restriction:  
> SAP AI Launchpad free plan is only available in SAP BTP free tier, not SAP BTP trial.
