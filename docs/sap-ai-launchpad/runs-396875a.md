...
-   To see runs for all scenarios, navigate to the *Runs* screen.

-   To see runs for a specific scenario, navigate to the *Scenarios* screen. Choose a scenario and select the *Runs* tab.
