...
You can stop a running execution by submitting a PATCH request to `$AI_API_URL/v2/lm/executions/$EXECUTION_ID`.
...
```
curl --request PATCH $AI_API_URL/v2/lm/executions/$EXECUTION_ID 
