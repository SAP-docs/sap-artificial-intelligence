...
-   [What Is SAP AI Core?](what-is-sap-ai-core-d029a32.md)
    ...
    -   [Choose an Instance](choose-an-instance-c58d4e5.md)
                    ...
                    -   Prerequisites
                        ...
                        -   [Data Management APIs](data-management-apis-ba55285.md)
                            -   [Pipelines API](pipelines-api-07adea9.md)
                                -   [Create a Document Grounding Pipeline Using the Pipelines API \(without Metadata\)](create-a-document-grounding-pipeline-using-the-pipelines-api-without-metadata-58fcc5e.md)
                                -   [Create a Document Grounding Pipeline Using the Pipelines API \(with Metadata\)](create-a-document-grounding-pipeline-using-the-pipelines-api-with-metadata-c272711.md)
                    ...
                    -   Prerequisites
                        ...
                        -   [Data Management APIs](data-management-apis-6348a01.md)
                            -   [Pipelines API](pipelines-api-d8cc0e3.md)
                                -   [Create a Document Grounding Pipeline Using the Pipelines API \(without Metadata\)](create-a-document-grounding-pipeline-using-the-pipelines-api-without-metadata-ff73612.md)
                                -   [Create a Document Grounding Pipeline Using the Pipelines API \(with Metadata\)](create-a-document-grounding-pipeline-using-the-pipelines-api-with-metadata-3c56d6c.md)
