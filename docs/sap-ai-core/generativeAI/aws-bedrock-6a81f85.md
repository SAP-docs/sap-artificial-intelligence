...
AWS Bedrock models are remote models.
...
### Claude 3 Haiku | Claude 4 Sonnet | Claude 4 Opus | Claude 4.5 Haiku | Claude 4.5 Sonnet | Claude 4.6 Opus | Claude 4 Sonnet | Claude 4.7 Opus | Claude 4.8 Opus
...
To enable streaming when using the Converse API, call the `$DEPLOYMENT_URL/converse-stream` endpoint instead of `/converse`.
...
[Access the Streaming using the SAP AI SDK for Java](https://sap.github.io/ai-sdk/docs/java/foundation-models/openai/chat-completion#stream-chat-completion)

[Access the Streaming using the SAP AI SDK for JavaScript](https://sap.github.io/ai-sdk/docs/js/foundation-models/openai/chat-completion#streaming)
