...
[Access the Deployment using the SAP AI SDK for Java](https://sap.github.io/ai-sdk/docs/java/ai-core/ai-core-deployment)

[Access the Deployment using the SAP AI SDK for JavaScript](https://sap.github.io/ai-sdk/docs/js/ai-core/ai-api)
