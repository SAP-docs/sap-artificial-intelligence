<!-- copy854f2b3c967f43779e3ad795ec5b4132 -->
...
> ### Note:  
> Configuration of the grounding module is consistent across orchestration versions 1 and 2.

Pretrained generative models are trained on broad, general-purpose datasets. They do not have direct access to your organization’s proprietary or real-time data.

Grounding addresses this limitation by:
...
This enables more accurate, business-specific, and up-to-date responses.

To index user-provided documents, the grounding module:

1.  Splits the documents into smaller content chunks
2.  Converts the chunks into vector representations \(embeddings\)
...
1.  The query is converted into a vector representation.
2.  The vector database is searched for similar content.
3.  Relevant information is returned and supplied to the generative model as context.
...
PDF, HTML, TXT, JPEG, JPG, DOCX, PNG, TIFF, PPT, JSON
...
Maximum of 8000 Documents per Pipeline
...
Knowledge Base Articles in HTML format
...
![Architecture diagram showing system components and workflow](images/grounding_e89c744.png)
...
To use the grounding module, choose from one of the following options.
...
[Access the Grounding using the SAP AI SDK for Java](https://sap.github.io/ai-sdk/docs/java/orchestration/chat-completion#grounding)

[Access the Grounding using the SAP AI SDK for JavaScript](https://sap.github.io/ai-sdk/docs/js/orchestration/chat-completion#grounding)
