...
-   **[Create a Document Grounding Pipeline Using the Pipelines API](create-a-document-grounding-pipeline-using-the-pipelines-api-d32b146.md "This API call creates a pipeline for indexing documents for a resource group.")**  
