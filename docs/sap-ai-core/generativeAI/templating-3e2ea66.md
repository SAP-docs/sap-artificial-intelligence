...
-   **[Prompt Caching](prompt-caching-77118d6.md "
...
-   **[Example of a Partial Orchestration Config](example-of-a-partial-orchestration-config-e64474f.md "")**  


**Related Information**  


[Access the Templating using the SAP AI SDK for Java](https://sap.github.io/ai-sdk/docs/java/orchestration/chat-completion#templating)

[Access the Templating using the SAP AI SDK for JavaScript](https://sap.github.io/ai-sdk/docs/js/orchestration/chat-completion#templating)
