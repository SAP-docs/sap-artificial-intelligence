<!-- copy515e83946fdd46dbbaf7edfcf4986d21 -->
...
Cron expressions have five fields, represented by a string of asterisks. The values for these fields are as follows:
...
The minimum interval supported in the pipeline API is 1 hour.
