...
GCP Vertex AI provides access to models from Google.
...
-   **[Get an Auth Token](get-an-auth-token-5ec7ec0.md "Authentication token retrieval enables secure access to your SAP instance. Set
		environment variables and use curl commands to obtain and use an access token. Use this
...
-   **[Batch Consumption](batch-consumption-e6a5a0e.md "")**  
