...
Send a POST request to the endpoint `$AI_API_URL/v2/lm/promptTemplates/import`, and include the name of your file in the `file` parameter.

 > ### Sample Code:  
> ```
> curl -X POST "$AI_API_URL/v2/lm/promptTemplates/import" \
