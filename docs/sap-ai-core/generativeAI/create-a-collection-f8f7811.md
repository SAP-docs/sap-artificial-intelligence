<!-- copyf8f7811cb91d4db0ae51845f03b6dd6f -->
...
1.  Send a POST request to the endpoint: `$AI_API_URL/v2/lm/document-grounding/vector/collections`.
    ...
    <your choice of valid uuid\>
    
    </td>
    <td valign="top">
    
    Your choice of UUID that can be used later to locate the collection
    ...
    > ### Note:  
    > The `id`, `title` and `metadata` fields are optional.
