<!-- loio9d9eb377f0bd4baab1f7e196df512bb7 -->
...
Filter pipelines by metadata configuration ID.
...
> ```
> curl --request GET  
>   --url "$AI_API_URL/v2/lm/document-grounding/pipelines?metadataConfigId=<yourMetadataConfigId>"  
>   --header "AI-Resource-Group: {{resource_group}}"
>   --header 'Authorization: Bearer {{access_token}}' 
> ```

Successful responses include response code **200** and a filtered list of pipelines.
