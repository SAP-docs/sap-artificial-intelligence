...
To create a configuration, send a POST request to endpoint `$AI_API_URL/v2/lm/configurations`.
...
You can start an evaluation by creating an execution for your configuration.



### Evaluation Job Progress Estimation
