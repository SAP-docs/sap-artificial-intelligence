<!-- copyba552855d4e74510843a88de44e5edfa -->
...
`$AI_API_URL/v2/lm/document-grounding/vector/search`
...
`$AI_API_URL/v2/lm/document-grounding/vector/documents`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections/{{collectionId}}`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections/{{collectionId}}/documents`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections/{{collectionId}}/documents/{{documentId}}`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections/{{id}}/creationStatus`
...
`$AI_API_URL/v2/lm/document-grounding/vector/collections/{{id}}/deletionStatus`
...
`$AI_API_URL/v2/lm/document-grounding/retrieval/dataRepositories`
...
`$AI_API_URL/v2/lm/document-grounding/retrieval/search`
...
`$AI_API_URL/v2/lm/document-grounding/retrieval/dataRepositories/{{repositoryId}}`
