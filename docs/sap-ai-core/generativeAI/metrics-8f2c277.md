<!-- loio8f2c2776293b48a3aceba88b2d001fa5 -->
...
-   **System-Defined Metrics:** SAP AI Core offers a set of predefined evaluation methods and metrics tailored for common LLM tasks, such as text generation, classification, and summarization. System-defined metrics ensure consistency and comparability across different models and experiments.
    ...
    For more information, see [System-Defined Evaluation Metrics](system-defined-evaluation-metrics-2ac6a08.md).
...
-   **Custom Metrics:** In addition to system-defined metrics, you can define and register your own custom metrics to address specific evaluation needs. This flexibility allows you to tailor performance measurement to your unique use cases and business requirements.
    ...
    For more information, see [Custom Metrics](custom-metrics-35dcc3e.md).

-   **Metric Management:** SAP AI Core provides tools for managing the entire lifecycle of metrics, including registration, versioning, and deprecation. You can organize metrics, track their usage, and ensure that the most relevant metrics are applied to your LLM evaluations.

    For more information, see [Metric Management](metric-management-8a6292b.md).
...
Complete the prerequisites. For more information, see [Register an Object Store for Optimizations](register-an-object-store-for-optimizations-54068a9.md).

You can create a custom metric. For more information, see [Custom Metrics](custom-metrics-35dcc3e.md).

-   **[System-Defined Evaluation Metrics](system-defined-evaluation-metrics-2ac6a08.md "")**  

-   **[Custom Metrics](custom-metrics-35dcc3e.md "In addition to system-defined evaluation metrics, you can define custom metrics to
