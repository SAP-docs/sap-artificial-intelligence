...
-   [Generative AI Hub](generative-ai-hub-7db524e.md)
    ...
    -   [Models](models-6440777.md)
        ...
        -   SAP
            ...
            -   [SAP-RPT-1.6](sap-rpt-1-6-cabd1cd.md)
    ...
    -   Model Consumption Methods
        ...
        -   [Tabular AI](tabular-ai-5b457e9.md)
            ...
            -   [Runtime Setup](runtime-setup-4562e3d.md)
                -   [Create a Tabular AI Deployment](create-a-tabular-ai-deployment-db2da6d.md)
                -   [Consume Tabular Orchestration](consume-tabular-orchestration-1cdac20.md)
    ...
    -   [Optimizations](optimizations-e50489d.md)
        ...
        -   [Prompt Optimization](prompt-optimization-f5af0bd.md)
            -   Prerequisites
                ...
                -   [Variable Mapping](variable-mapping-bb3d4f8.md)
