...
-   **[Create a Generic Secret for Google Drive](create-a-generic-secret-for-google-drive-99582a7.md "Creates a generic secret with base64‑encoded credentials required to connect Google
...
-   **[Grounding Generic Secrets for ServiceNow](grounding-generic-secrets-for-servicenow-3eae336.md "Your cloud storage credentials are managed using secrets. Secrets are a means of allowing and controlling connections across directories
    and tools, without compromising your credentials.")**  
Your cloud storage credentials are managed using secrets. Secrets are a means of allowing and controlling connections across directories and tools, without compromising your credentials.
