...
1.  Register your object store secrets. For more information, see [Register an Object Store for Optimizations](register-an-object-store-for-optimizations-54068a9.md).
...
-   **[Response Formatting](response-formatting-e827862.md "
		
	")**  

-   **[Tool Calling](tool-calling-69455a6.md "")**  
