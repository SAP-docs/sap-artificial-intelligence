<!-- loio2afd28ed44aa4296852f386e68ebe697 -->

# Create a Pipeline with ServiceNow



<a name="loio2afd28ed44aa4296852f386e68ebe697__section_ljc_ksf_ngc"/>
...
<a name="loio2afd28ed44aa4296852f386e68ebe697__section_vcb_j5f_ngc"/>
...
<a name="loio2afd28ed44aa4296852f386e68ebe697__section_nv3_pcg_ngc"/>

## Without Metadata

The following shows an example of a ServiceNow site to be indexed.
...
The name of the generic secret created for ServiceNow
...
<a name="loio2afd28ed44aa4296852f386e68ebe697__section_v2s_pcg_ngc"/>
...
The metadata attribute is optional. It accepts the destination name, which is used to connect to the ServiceNow metadata server to retrieve metadata for document indexing.
...
The following shows an example of a ServiceNow site to be indexed with metadata.
...
The name of the generic secret created for the ServiceNow Metadata Server
...
The following shows an example of a ServiceNow site to be indexed at regular intervals.
...
<a name="loio2afd28ed44aa4296852f386e68ebe697__section_c2d_1wg_jgc"/>
