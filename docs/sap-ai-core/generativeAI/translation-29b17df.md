...
The input translation module helps improve answer quality when the configured model performs better with input in a specific language, such as English.



## Output Translation

The output translation module is optional. It translates LLM output into a chosen target language.
...
The module supports SAP's Document Translation service, which is part of the SAP Translation Hub.
