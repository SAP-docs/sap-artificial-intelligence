...
> ### Note:  
> Before you can delete an instance, you must stop any running exeuctions. You do so by submitting a PATCH request to `$AI_API_URL/v2/lm/executions/$EXECUTION_ID`.
> 
> For more information, see [Stop a Single Training Instance](stop-a-single-training-instance-07870df.md)
...
```
curl --request DELETE $AI_API_URL/v2/lm/executions/$EXECUTION_ID \
