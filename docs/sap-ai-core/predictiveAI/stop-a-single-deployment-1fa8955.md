...
Update the deployment by submitting a PATCH request to `$AI_API_URL/v2/lm/deployments/<deploymentid>`.
...
Check the status of the deployment by submitting a GET request to `$AI_API_URL/v2/lm/deployments/<deploymentid>`.
