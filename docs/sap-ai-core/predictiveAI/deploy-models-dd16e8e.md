...
3.  Check the status of the deployment by sending a GET request to `$AI_API_URL/v2/lm/deployments/<deploymentid>`.
...
<a name="concept_z3s_f3h_vcc__d40e1165"/>
...
<a name="concept_z3s_f3h_vcc__d40e1196"/>
