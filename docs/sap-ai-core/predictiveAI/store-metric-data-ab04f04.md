...
> ### Recommendation:  
> Do not use the tracking functions provided by SAP AI Core to track sensitive information. For more information, see [Security](https://help.sap.com/viewer/2d6c5984063c40a59eda62f4a9135bee/CLOUD/en-US/a476d3c15bf04494907dcdb7a9aee131.html "Here, we'll explain some of the security aspects of SAP AI Core.") :arrow_upper_right:.
